...
dyHistogram(mydata, low = -300000, up = 20000000, same_scale = FALSE,  bi =500, set_x_marker = 0, colS = colSet)
```

```{r, eval = TRUE, echo = FALSE, fig.show = "asis", fig.width=10, fig.height=5, result = "hide"}
# Histogram dy in dependcy of the slope
dymaxHistogram(mydata, low = -3000000, up = 2000000, same_scale = TRUE,  bi =500, set_x_marker = 0, colS = colSet)
```
